...
> **Repo scope:** This workspace ships **`apps/loyalty`** and shared backend packages. QPlatform queue UI (`apps/web`, `apps/admin`) lives in sibling **`../QMS`**. See [architecture/REPO_BOUNDARIES.md](./architecture/REPO_BOUNDARIES.md).
...
- QPlatform ↔ LMS connector: [architecture/qplatform-integration.md](./architecture/qplatform-integration.md)
