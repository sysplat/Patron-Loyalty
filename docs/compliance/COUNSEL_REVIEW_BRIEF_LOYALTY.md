...
- **Relationship to QPlatform:** Separately licensed product. May connect to QPlatform queue data when both are on the same org; loyalty-only tenants use imports, staff entry, or the Integration API.
...
**Companion internal docs:** `docs/compliance/COUNSEL_REVIEW_BRIEF.md` (QPlatform queue product), `SUPPORT_OPERATIONS.md`, `GLOBAL_COMPLIANCE_PROGRAM.md`.
...
1. Read this brief and QPlatform `docs/compliance/SUPPORT_OPERATIONS.md` for shared subprocessors/AI ops.
