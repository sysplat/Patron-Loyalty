import type { UserStatus, BranchStatus, ServiceStatus, QueueStatus, TicketStatus, TicketSource, DisplayDeviceType, DisplayDeviceStatus, OnboardingStep, SubscriptionStatus, NotificationChannel, DayOfWeek } from './enums';
...
export interface WsTicketEvent {
    type: 'ticket_booked' | 'ticket_called' | 'ticket_completed' | 'ticket_cancelled' | 'ticket_no_show' | 'ticket_transferred';
    ticket: TicketDto;
    queueId: string;
    branchId: string;
    timestamp: string;
