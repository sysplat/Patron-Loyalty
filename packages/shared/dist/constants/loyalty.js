...
exports.LOYALTY_STAMP_CARD_TARGET = 10;
...
exports.LOYALTY_REDEMPTION_STATUSES = {
    PENDING: 'pending',
    FULFILLED: 'fulfilled',
    CANCELLED: 'cancelled',
};
exports.LOYALTY_CAMPAIGN_SEND_STATUSES = {
    QUEUED: 'queued',
    SENDING: 'sending',
    SENT: 'sent',
    FAILED: 'failed',
