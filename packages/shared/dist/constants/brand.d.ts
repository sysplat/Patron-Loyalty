...
export declare const DEFAULT_NOREPLY_EMAIL = "noreply@queueplatform.com";
/** Default inbox for tenant support requests when SUPPORT_CONTACT_EMAIL is unset. */
export declare const DEFAULT_SUPPORT_EMAIL = "support@queueplatform.com";
/** Public legal / privacy contact (shown on legal pages). */
export declare const DEFAULT_LEGAL_EMAIL = "legal@queueplatform.com";
